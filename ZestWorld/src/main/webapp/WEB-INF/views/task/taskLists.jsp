...
<c:forEach items="${list2}" var="j" varStatus="status">	
	...
	<div class="task-content" id="taskTitle">
 	...
 	${j.title}   
 		<span class="glyphicon glyphicon-check" style="margin-left: 248px;cursor:pointer" data-toggle="modal" data-target="#detailModal" onclick="detailModalView(${j.task_id})"></span>
	</div>
	</c:if>
</c:forEach>	
</div>
